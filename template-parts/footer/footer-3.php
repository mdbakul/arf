...
*/
    ...
    Newsletter', 'arf' ) );
    $footer_top_cta = get_theme_mod( 'footer_top_cta', __( 'do shortcode', 'arf' ) );
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5 col-md-12">
                        <div class="tp-footer-subscribe-wrapper-title d-flex align-items-center">
                            ...
                            <h3 class="tp-footer-subscribe-title"> <?php echo arf_kses( $footer_top_cta_title ); ?></h3>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="tp-footer-copyright-inner">
                        <p><?php print arf_copyright_text(); ?></p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
