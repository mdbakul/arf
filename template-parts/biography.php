<?php
    ...
    $author_info = get_the_author_meta( 'arf_write_by');
    $facebook_url = get_the_author_meta( 'arf_facebook' );
    $twitter_url = get_the_author_meta( 'arf_twitter' );
    $linkedin_url = get_the_author_meta( 'arf_linkedin' );
    $instagram_url = get_the_author_meta( 'arf_instagram' );
    $arf_url = get_the_author_meta( 'arf_youtube' );
    $arf_write_by = get_the_author_meta( 'arf_write_by' );
...
<div class="blogsingle__author mt-4">                        
    <h5><?php echo esc_html__('Author post editor', "arf");?></h5>
