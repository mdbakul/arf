<?php 
   ...
   // Header Address Link
   $header_top_address_link = get_theme_mod( 'header_address_link', __( '#', 'arf' ) );
   ...
   $header_language_switch = get_theme_mod( 'header_language_switch', __( 'false', 'arf' ) );
   ...
   $arf_menu_end = $arf_header_right ? '' : 'd-flex justify-content-end';
                        ...
                        <div class="tp-header-contact-2 d-flex align-items-center">
                            ...
                            <div class="tp-header-contact-inner d-none d-xl-flex align-items-center">
                                ...
                                <div class="tp-header-contact-content">
                                    ...
                                    <span><a href="tel:<?php echo arf_kses($phone_number_url); ?>"><?php echo esc_html( $header_top_phone ); ?></a></span>
                                </div>
                            </div>
                            <?php endif; ?>
                        </div>
